...
def extract_landmarks_from_video(video_path):
    """Extracts landmarks from a video using MediaPipe Holistic model.

    Args:
        video_path (str): Path to the video file.

    Returns:
        Tuple of lists: Tuple containing left hand landmarks list and right hand landmarks list.
    """
    ...
    try:
        ...
        while cap.isOpened():
            ...
            if results.left_hand_landmarks:
                left_hand_landmarks_list.append(results.left_hand_landmarks.landmark)
            else:
                left_hand_landmarks_list.append([])

            if results.right_hand_landmarks:
                right_hand_landmarks_list.append(results.right_hand_landmarks.landmark)
            else:
        ...
        # return left_hand_landmarks_list, right_hand_landmarks_list
        return results
